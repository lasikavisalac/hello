public class Day5marks {
    ...
    static class Student {
        ...
        void show() {
            System.out.println(name + " lasi " + regNo + " 232425 " + dept);
    ...
    public static void main(String[] args) {
        Student s1 = new Student("lasi", 101, "CSE");
        Student s2 = new Student("lasi", 102, "ECE");
        Student s3 = new Student("lasi", 103, "MECH");
        ...
        s2.show();
        s3.show();
        System.out.println("lasi Maths Mark: " + s1.getMaths());
        System.out.println("lasi Physics Mark: " + s2.getPhysics());
        System.out.println("lasi Chemistry Mark: " + s3.getChemistry());
    }
}
